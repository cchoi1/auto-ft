...
#SBATCH --job-name="cifar-cinic-autoft-1inner-100ep" # Name the job (for easier monitoring)
#SBATCH --output=cifar-cinic-autoft-1inner-100ep.log  # Name of the output log file
...
--id CIFAR10 --ood CINIC --eval-datasets CIFAR101,CIFAR102,CIFAR10,CINIC \
