...
#SBATCH --job-name="cifar-autoft-1inner-100ep-unlabeled190" # Name the job (for easier monitoring)
#SBATCH --output=cifar-autoft-1inner-100ep-unlabeled190.log  # Name of the output log file
