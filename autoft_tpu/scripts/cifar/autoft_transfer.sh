...
#SBATCH --job-name="cifar-autoft-1inner-100ep-transfer-mnist" # Name the job (for easier monitoring)
#SBATCH --output=cifar-autoft-1inner-100ep-transfer-mnist.log  # Name of the output log file
...
--id MNIST --ood CIFAR10C --eval-datasets MNISTC,CIFAR101,CIFAR102,CIFAR10,CIFAR10C \
