...
python3 main.py --method surgical --ft_id_ood --ft_id_dist brightness --ft_ood_dist impulse_noise --test_dist mnistc \
--optimizer_name LOptNet --l2_lambda 1.5 --val ood
...
#--meta_steps 160 --l2_lambda $LAMBDA --patience 3 --val ood
#done