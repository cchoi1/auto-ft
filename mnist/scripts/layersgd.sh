...
#SBATCH --job-name="layer-sgd-mnist" # Name the job (for easier monitoring)
...
#--inner_steps 5 --meta_steps 150 --patience 3 --val ood --no_wandb
...
python3 main.py --method ours --pretrain_dist mnist --ft_id_dist brightness --ft_ood_dist impulse_noise --test_dist mnistc \
--optimizer_name LayerSGD --num_nets 1 \
--inner_steps 10 --meta_steps 100 --patience 3 --val ood --no_wandb