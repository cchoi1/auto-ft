...
# def eval_single_dataset(encoder, classification_head, dataset, args):
#     #TODO add freeze encoder
...
#
#
# def evaluate(encoder, classification_head, args):
...
#         results = eval_single_dataset(encoder, classification_head, dataset, args)
#         torch.cuda.empty_cache()
#         if 'top1' in results:
