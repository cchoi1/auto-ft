...
#SBATCH --job-name="imagenet16-autoft-noflyp-20inner-100ep-1000ex-finetune-4gpu" # Name the job (for easier monitoring)
#SBATCH --output=imagenet16-autoft-noflyp-20inner-100ep-1000ex-finetune-4gpu.log  # Name of the output log file
