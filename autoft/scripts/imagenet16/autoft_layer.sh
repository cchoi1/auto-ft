...
#SBATCH --job-name="imagenet16-autoft-layer-20inner-500ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=imagenet16-autoft-layer-20inner-500ep-1000ex.log  # Name of the output log file
...
--ft_data /iris/u/cchoi1/Data/csv/imagenet16_onecap.csv \
