...
#SBATCH --job-name="imagenet16-autoft-10inner-1000ep-15000ex" # Name the job (for easier monitoring)
#SBATCH --output=imagenet16-autoft-10inner-1000ep-15000ex.log  # Name of the output log file
...
--id ImageNet16 --ood ImageNetC --eval-datasets ImageNetA,ImageNetR,ImageNetSketch,ImageNetV2,ObjectNet,ImageNet,ImageNetC \
