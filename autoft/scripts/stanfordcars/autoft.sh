...
#SBATCH --job-name="stanfordcars-autoft-50inner-500ep-1000ex-class-balanced" # Name the job (for easier monitoring)
#SBATCH --output=stanfordcars-autoft-50inner-500ep-1000ex-class-balanced.log  # Name of the output log file
