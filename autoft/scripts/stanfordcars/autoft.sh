...
#SBATCH --job-name="stanfordcars-autoft-100inner-300ep-1000ex-class-balanced-regen-noregen" # Name the job (for easier monitoring)
#SBATCH --output=stanfordcars-autoft-100inner-300ep-1000ex-class-balanced-regen-noregen.log  # Name of the output log file
...
--autoft_epochs 300 --inner_steps 100 --lr 1e-5 --wd 0.0 \
...
--workers 2 --relative_to_flyp --regenerate_head