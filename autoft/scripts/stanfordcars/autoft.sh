...
#SBATCH --job-name="stanfordcars-autoft-500inner-300ep-1000ex-class-balanced-regen-noregen" # Name the job (for easier monitoring)
#SBATCH --output=stanfordcars-autoft-500inner-300ep-1000ex-class-balanced-regen-noregen.log  # Name of the output log file
