...
#SBATCH --job-name="stanfordcars-autoft-50inner-500ep-200ex-class-balanced-regen-noregen" # Name the job (for easier monitoring)
#SBATCH --output=stanfordcars-autoft-50inner-500ep-200ex-class-balanced-regen-noregen.log  # Name of the output log file
...
--num_ood_hp_examples 200 --use_class_balanced_ood --ft_epochs 100 \
...
--workers 2 --relative_to_flyp --regenerate_head --clip_gradient