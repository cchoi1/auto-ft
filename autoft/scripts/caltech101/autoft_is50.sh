...
#SBATCH --job-name="caltech101-autoft-50inner-200ep-1000ex-class-balanced-seeds" # Name the job (for easier monitoring)
#SBATCH --output=caltech101-autoft-50inner-200ep-1000ex-class-balanced-seeds.log  # Name of the output log file
...
--workers 2 --no_regenerate_head --repeats 2