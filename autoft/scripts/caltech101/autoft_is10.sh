...
#SBATCH --job-name="caltech101-autoft-10inner-100ep-1000ex-class-balanced-seeds" # Name the job (for easier monitoring)
#SBATCH --output=caltech101-autoft-10inner-100ep-1000ex-class-balanced-seeds.log  # Name of the output log file
...
--workers 2 --repeats 3 --no_regenerate_head