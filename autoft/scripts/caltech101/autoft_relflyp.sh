...
#SBATCH --job-name="caltech101-autoft-50inner-200ep-1000ex-class-balanced-relflyp" # Name the job (for easier monitoring)
#SBATCH --output=caltech101-autoft-50inner-200ep-1000ex-class-balanced-relflyp.log  # Name of the output log file
...
--workers 2 --regenerate_head --relative_to_flyp