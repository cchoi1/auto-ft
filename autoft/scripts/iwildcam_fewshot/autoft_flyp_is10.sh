...
#SBATCH --job-name="iwildcam4-autoft-flyp-10inner-100ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam4-autoft-flyp-10inner-100ep-1000ex.log  # Name of the output log file
...
--id IWildCam4Train --ood IWildCamOODVal --eval-datasets IWildCam4IDVal,IWildCamIDTest,IWildCamOODTest \
