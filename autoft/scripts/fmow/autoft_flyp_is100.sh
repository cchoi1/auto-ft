...
#SBATCH --job-name="fmow-autoft-flyp-100inner-500ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=fmow-autoft-flyp-100inner-500ep-1000ex.log  # Name of the output log file
