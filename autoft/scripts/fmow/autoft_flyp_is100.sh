...
#SBATCH --job-name="fmow-autoft-flyp-100inner-100ep-1000ex-2" # Name the job (for easier monitoring)
#SBATCH --output=fmow-autoft-flyp-100inner-100ep-1000ex-2.log  # Name of the output log file
