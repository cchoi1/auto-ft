...
#SBATCH --job-name="fmow-autoft-layer2-flyp-100inner-100ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=fmow-autoft-layer2-flyp-100inner-100ep-1000ex.log  # Name of the output log file
...
--autoft_epochs 100 --inner_steps 100 \
