...
#SBATCH --job-name="fmow-autoft-100inner-100ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=fmow-autoft-100inner-100ep-1000ex.log  # Name of the output log file
