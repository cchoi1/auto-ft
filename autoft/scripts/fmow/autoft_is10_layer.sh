...
#SBATCH --job-name="fmow-autoft-10inner-100ep-layer" # Name the job (for easier monitoring)
#SBATCH --output=fmow-autoft-10inner-100ep-layer.log  # Name of the output log file
