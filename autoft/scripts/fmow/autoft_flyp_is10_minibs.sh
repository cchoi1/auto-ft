...
#SBATCH --job-name="fmow-autoft-flyp-10inner-100ep-1000ex-minibatch" # Name the job (for easier monitoring)
#SBATCH --output=fmow-autoft-flyp-10inner-100ep-1000ex-minibatch.log  # Name of the output log file
