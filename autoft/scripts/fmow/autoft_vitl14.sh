...
#SBATCH --job-name="fmow-autoft-vitl14-10inner-100ep-1000ex-class-balanced-clipgrad" # Name the job (for easier monitoring)
#SBATCH --output=fmow-autoft-vitl14-10inner-100ep-1000ex-class-balanced-clipgrad.log  # Name of the output log file
...
python3 src/main.py --method autoft --model ViT-L/14 --data-location /iris/u/yoonho/data/wilds \
...
--load /iris/u/cchoi1/robust-optimizer/autoft/zeroshot/clip_vitl14_fmow2.pt \
