...
#SBATCH --job-name="fmow-autoft-ce-flyp-dcm-10inner-100ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=fmow-autoft-ce-flyp-dcm-10inner-100ep-1000ex.log  # Name of the output log file
...
--load /iris/u/cchoi1/robust-optimizer/autoft/zeroshot/clip_vitb16_fmow2.pt \
--losses ce flyp \
--load_hparams ./hparams/FMOW/flyp_ce_is=10_evals=100_ex=1000.json \
--workers 2
