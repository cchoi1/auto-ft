...
#SBATCH --job-name="fmow-autoft-flyp-10inner-100ep-63ex" # Name the job (for easier monitoring)
#SBATCH --output=fmow-autoft-flyp-10inner-100ep-63.log  # Name of the output log file
...
--num_ood_hp_examples 63 --ft_epochs 20 \
