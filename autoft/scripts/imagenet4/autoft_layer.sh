...
#SBATCH --job-name="imagenet4-autoft-layer-100inner-500ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-layer-100inner-500ep-1000ex.log  # Name of the output log file
...
--num_ood_hp_examples 1000 --inner_steps 100 --autoft_epochs 500 --ft_epochs 10 \
