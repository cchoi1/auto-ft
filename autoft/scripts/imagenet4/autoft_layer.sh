...
#SBATCH --job-name="imagenet4-autoft-50inner-100ep-1000ex-layer" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-50inner-100ep-1000ex-layer.log  # Name of the output log file
