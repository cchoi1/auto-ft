...
#SBATCH --job-name="imagenet4-autoft-500inner-100ep-1000ex-4gpu" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-500inner-100ep-1000ex-4gpu.log  # Name of the output log file
...
--num_ood_hp_examples 1000 --inner_steps 500 --autoft_epochs 100 --ft_epochs 10 \
