...
#SBATCH --job-name="imagenet4-autoft-noflyp-100inner-100ep-1000ex-4gpu" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-noflyp-100inner-100ep-1000ex-4gpu.log  # Name of the output log file
