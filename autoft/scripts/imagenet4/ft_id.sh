...
#SBATCH --job-name="imagenet4-ft-id-4gpu-csv" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-ft-id-4gpu-csv.log  # Name of the output log file
...
--num_ood_hp_examples -1 --inner_steps 1 --autoft_epochs 1 --ft_epochs 10 \
...
--losses ce --template openai_imagenet_template \
