...
#SBATCH --job-name="imagenet4-autoft-finetune-10inner-100ep-1000ex-2gpus" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-finetune-10inner-100ep-1000ex-2gpus.log  # Name of the output log file
...
--ft_data /iris/u/cchoi1/Data/csv/imagenet4.csv --val_data /iris/u/cchoi1/Data/csv/imagenet4.csv \
