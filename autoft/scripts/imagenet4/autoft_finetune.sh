...
#SBATCH --job-name="imagenet4-autoft-5inner-100ep-1000ex-finetune-2gpus" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-5inner-100ep-1000ex-finetune-2gpus.log  # Name of the output log file
