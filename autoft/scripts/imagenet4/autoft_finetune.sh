...
#SBATCH --job-name="imagenet4-autoft-finetune-5inner-100ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-finetune-5inner-100ep-1000ex.log  # Name of the output log file
