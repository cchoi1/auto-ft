...
#SBATCH --job-name="imagenet4-autoft-5inner-100ep-1000ex-finetune" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-5inner-100ep-1000ex-finetune.log  # Name of the output log file
