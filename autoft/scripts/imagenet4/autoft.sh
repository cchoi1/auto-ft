...
#SBATCH --job-name="imagenet4-autoft-50inner-100ep-15000ex" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-50inner-100ep-15000ex.log  # Name of the output log file
...
--num_ood_hp_examples 15000 --use_class_balanced_ood --inner_steps 50 --autoft_epochs 100 --ft_epochs 10 \
--lr 1e-5 --wd 0.1 --batch-size 256 --warmup_length 500 --accumulation_steps 2 \
