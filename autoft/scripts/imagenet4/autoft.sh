...
#SBATCH --job-name="imagenet4-autoft-imagenetv2-5inner-100ep-1000ex-relflyp-noregen" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-imagenetv2-5inner-100ep-1000ex-relflyp-noregen.log  # Name of the output log file
