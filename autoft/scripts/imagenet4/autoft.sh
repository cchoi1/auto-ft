...
#SBATCH --job-name="imagenet4-autoft-10inner-1000ep-15000ex" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-10inner-1000ep-15000ex.log  # Name of the output log file
