...
#SBATCH --job-name="imagenet4-autoft-imagenetv2-5inner-100ep-1000ex-relflyp" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-autoft-imagenetv2-5inner-100ep-1000ex-relflyp.log  # Name of the output log file
...
--id ImageNet4 --ood ImageNetV2 --eval-datasets ImageNetA,ImageNetR,ImageNetSketch,ImageNetV2,ObjectNet,ImageNet4 \
...
--ft_data /iris/u/cchoi1/Data/csv/imagenet4_onecap.csv --val_data /iris/u/cchoi1/Data/csv/imagenet4_val_onecap.csv \
