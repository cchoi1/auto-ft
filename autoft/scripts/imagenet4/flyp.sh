...
#SBATCH --job-name="imagenet4-flyp-medtemp-noregen" # Name the job (for easier monitoring)
#SBATCH --output=imagenet4-flyp-medtemp-noregen.log  # Name of the output log file
...
--lr 1e-5 --wd 0.1 --batch-size 64 --warmup_length 0 --accumulation_steps 8 \
--load /iris/u/cchoi1/robust-optimizer/autoft/zeroshot/clip_vitb16_imagenet2.pt \
--ft_data /iris/u/cchoi1/Data/csv/imagenet4_medium.csv \
--csv-img-key filepath --csv-caption-key title --get_labeled_csv \
--losses flyp --template openai_imagenet_template \
--relative_to_flyp --no_regenerate_head --workers 4
