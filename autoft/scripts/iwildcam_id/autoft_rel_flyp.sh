...
#SBATCH --job-name="iwildcam-id-autoft-50inner-500ep-1000ex-class-balanced-relflyp-regen-noregen" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-id-autoft-50inner-500ep-1000ex-class-balanced-regen-noregen.log  # Name of the output log file
...
--losses ce dcm entropy flyp hinge l1init l1zero l2init l2zero --clip_gradient --relative_to_flyp --regenerate_head --no_regenerate_head