...
#SBATCH --job-name="iwildcam-id-autoft-50inner-500ep-1000ex-class-balanced-clipgrad-relflyp-2" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-id-autoft-50inner-500ep-1000ex-class-balanced-clipgrad-2.log  # Name of the output log file
