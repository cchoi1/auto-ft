...
#SBATCH --job-name="iwildcam-id-cdf-autoft-50inner-500ep-1000ex-class-balanced-clipgrad-relflyp-regen-noregen" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-id-cdf-autoft-50inner-500ep-1000ex-class-balanced-clipgrad-regen-noregen.log  # Name of the output log file
...
--losses ce dcm flyp --clip_gradient --relative_to_flyp --regenerate_head --no_regenerate_head