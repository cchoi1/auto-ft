...
#SBATCH --job-name="iwildcam-id-autoft-10inner-100ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-id-autoft-10inner-100ep-1000ex.log  # Name of the output log file
...
--autoft_epochs 100 --inner_steps 10 --lr 1e-5 --wd 0.2 \
