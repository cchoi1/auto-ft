...
#SBATCH --job-name="iwildcam-autoft-50inner-200ep-1000ex-minibatch-2" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-50inner-200ep-1000ex-minibatch-2.log  # Name of the output log file
...
--num_ood_hp_examples -1 --val_mini_batch_size 1000 --autoft_epochs 200 --inner_steps 50 \
--lr 1e-5 --wd 0.1 --batch-size 128 --accumulation_steps 2 \
--ft_epochs 20 --warmup_length 500 \
