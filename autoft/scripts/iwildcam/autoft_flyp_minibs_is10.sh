...
#SBATCH --job-name="iwildcam-autoft-10inner-500ep-1000ex-minibatch" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-10inner-500ep-1000ex-minibatch.log  # Name of the output log file
...
--num_ood_hp_examples -1 --val_mini_batch_size 1000 --autoft_epochs 500 --inner_steps 10 \
