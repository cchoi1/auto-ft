...
#SBATCH --job-name="iwildcam-autoft-flyp-50inner-500ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-flyp-50inner-500ep-1000ex.log  # Name of the output log file
...
--num_ood_hp_examples 1000 --ft_epochs 20 --autoft_epochs 500 --inner_steps 50 \
