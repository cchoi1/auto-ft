...
#SBATCH --job-name="iwildcam-autoft-vitl14-10inner-100ep-1000ex-class-balanced" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-vitl14-10inner-100ep-1000ex-class-balanced.log  # Name of the output log file
...
--num_ood_hp_examples 1000 --use_class_balanced_ood --ft_epochs 20 --autoft_epochs 100 --inner_steps 10 \
