...
#SBATCH --job-name="iwildcam-autoft-vitl14-50inner-500ep-1000ex-class-balanced-clipgrad-noregenhead" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-vitl14-50inner-500ep-1000ex-class-balanced-clipgrad-noregenhead.log  # Name of the output log file
