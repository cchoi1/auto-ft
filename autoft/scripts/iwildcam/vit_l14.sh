...
#SBATCH --job-name="iwildcam-autoft-vitl14-10inner-100ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-vitl14-10inner-100ep-1000ex.log  # Name of the output log file
