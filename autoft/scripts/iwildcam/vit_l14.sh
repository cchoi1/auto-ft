...
#SBATCH --job-name="iwildcam-autoft-vitl14-ce-dcm-flyp-50inner-500ep-1620ex-class-balanced" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-vitl14-ce-dcm-flyp-50inner-500ep-1620ex-class-balanced.log  # Name of the output log file
