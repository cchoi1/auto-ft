...
#SBATCH --job-name="test_saving2" # Name the job (for easier monitoring)
#SBATCH --output=test_saving2.log  # Name of the output log file
#SBATCH --mail-type=END,FAIL          # Mail events (NONE, BEGIN, END, FAIL, ALL)
#SBATCH --mail-user=cchoi1@stanford.edu     # Where to send mail

# iwildcam-autoft-10inner-200ep.log
...
--num_ood_hp_examples -1 --ft_epochs 2 \
