...
#SBATCH --job-name="iwildcam-autoft-layer-50inner-500ep" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-layer-50inner-500ep.log  # Name of the output log file
