python3 src/zeroshot.py --method autoft --model ViT-L/14 --data-location /iris/u/cchoi1/Data \
...
--batch-size 256 --warmup_length 500 --save ./zeroshot/clip_vitl14_iwildcam2.pt