...
#SBATCH --job-name="iwildcam-autoft-1000inner-200ep-1000ex-class-balanced-relflyp" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-1000inner-200ep-1000ex-class-balanced-relflyp.log  # Name of the output log file
...
--num_ood_hp_examples 1000 --use_class_balanced_ood --ft_epochs 20 --autoft_epochs 300 --inner_steps 1000 \
