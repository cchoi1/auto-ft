...
#SBATCH --job-name="iwildcam-autoft-50inner-500ep-1620ex-class-balanced-clipgrad" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-50inner-500ep-1620ex-class-balanced-clipgrad.log  # Name of the output log file
