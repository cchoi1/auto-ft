...
#SBATCH --job-name="iwildcam-autoft-10inner-100ep-1620ex-class-balanced-clipgrad" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-10inner-100ep-1620ex-class-balanced-clipgrad.log  # Name of the output log file
...
--num_ood_hp_examples 1620 --use_class_balanced_ood --ft_epochs 20 --autoft_epochs 100 --inner_steps 10 \
...
--losses ce hinge entropy dcm flyp l1zero l2zero l1init l2init --clip_gradient --autoft_repeats 3
