...
#SBATCH --job-name="iwildcam-autoft-10inner-100ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-10inner-100ep-1000ex.log  # Name of the output log file
...
--lr 1e-5 --wd 0.1 --batch-size 64 --warmup_length 500 \
