...
#SBATCH --job-name="iwildcam-autoft-500inner-200ep-1000ex-class-balanced-relflyp" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-500inner-200ep-1000ex-class-balanced-relflyp.log  # Name of the output log file
