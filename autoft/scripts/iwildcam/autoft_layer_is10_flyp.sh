...
#SBATCH --job-name="iwildcam-autoft-layer-flyp-10inner-500ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-layer-flyp-10inner-500ep-1000ex.log  # Name of the output log file
