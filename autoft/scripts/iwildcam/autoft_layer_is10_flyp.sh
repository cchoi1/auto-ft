...
#SBATCH --job-name="iwildcam-autoft-layer-10inner-100ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-layer-10inner-100ep-1000ex.log  # Name of the output log file
