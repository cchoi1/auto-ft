...
#SBATCH --job-name="iwildcam-autoft-layer-flyp-10inner-100ep" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-layer-flyp-10inner-100ep.log  # Name of the output log file
