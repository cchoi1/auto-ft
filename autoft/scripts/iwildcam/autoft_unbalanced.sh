...
#SBATCH --job-name="iwildcam-autoft-500inner-200ep-1000ex-unbalanced-relflyp-regen" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-500inner-200ep-1000ex-unbalanced-relflyp-regen.log  # Name of the output log file
...
--num_ood_hp_examples 1000 --ft_epochs 20 --autoft_epochs 300 --inner_steps 500 \
...
--clip_gradient --relative_to_flyp --regenerate_head \
--no_regenerate_head
