...
#SBATCH --job-name="iwildcam-unlabeled-autoft-100inner-100ep-1000ex-finetune" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-unlabeled-autoft-100inner-100ep-1000ex-finetune.log  # Name of the output log file
...
--unlabeled_id IWildCamUnlabeledTrain \
