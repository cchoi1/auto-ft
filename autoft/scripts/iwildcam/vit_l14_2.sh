...
#SBATCH --job-name="iwildcam-autoft-vitl14-100inner-500ep-1000ex-class-balanced-relflyp-regen" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-vitl14-100inner-500ep-1000ex-class-balanced-relflyp-regen.log  # Name of the output log file
...
--lr 1e-5 --wd 0.0 --batch-size 128 --warmup_length 500 --accumulation_steps 2 \
...
--losses ce dcm entropy flyp hinge l1init l1zero l2init l2zero --relative_to_flyp --clip_gradient --regenerate_head --no_regenerate_head