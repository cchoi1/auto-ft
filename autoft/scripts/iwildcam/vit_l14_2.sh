...
#SBATCH --job-name="iwildcam-autoft-vitl14-1000inner-500ep-1000ex-class-balanced-noinnersched-relflyp" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-vitl14-1000inner-500ep-1000ex-class-balanced-noinnersched-relflyp.log  # Name of the output log file
...
--num_ood_hp_examples 1000 --use_class_balanced_ood --ft_epochs 20 --autoft_epochs 500 --inner_steps 1000 \
