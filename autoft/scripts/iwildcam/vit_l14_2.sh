...
#SBATCH --job-name="iwildcam-autoft-vitl14-ce-dcm-flyp-100inner-500ep-1000ex-class-balanced-noinnersched" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-vitl14-ce-dcm-flyp-100inner-500ep-1000ex-class-balanced-noinnersched.log  # Name of the output log file
