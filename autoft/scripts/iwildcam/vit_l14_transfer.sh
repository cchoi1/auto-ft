...
#SBATCH --job-name="iwildcam-autoft-vitl14-336px-ce-dcm-flyp-transfer-nolrwd-2gpu" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-vitl14-336px-ce-dcm-flyp-transfer-nolrwd-2gpu.log  # Name of the output log file
