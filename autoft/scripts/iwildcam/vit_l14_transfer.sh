...
#SBATCH --gres=gpu:10 # Request one GPU
#SBATCH --cpus-per-task=4 # Request 8 CPUs for this task
#SBATCH --job-name="iwildcam-autoft-vitl14-ce-dcm-flyp-transfer-nolrwd-10gpu" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-vitl14-ce-dcm-flyp-transfer-nolrwd-10gpu.log  # Name of the output log file
