...
#SBATCH --job-name="iwildcam-autoft-vitl14-ce-dcm-flyp-transfer-nolrwd" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-vitl14-ce-dcm-flyp-transfer-nolrwd.log  # Name of the output log file
