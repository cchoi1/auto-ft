...
#SBATCH --job-name="iwildcam-flyp" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-flyp.log  # Name of the output log file
...
--losses flyp \
--load_hparams /iris/u/cchoi1/robust-optimizer/autoft/hparams/IWildCam/flyp.json