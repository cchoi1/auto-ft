...
#SBATCH --job-name="iwildcam-autoft-ce-flyp-dcm-10inner-100ep-1000ex-minibatch" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-ce-flyp-dcm-10inner-100ep-1000ex-minibatch.log  # Name of the output log file
...
--num_ood_hp_examples -1 --val_mini_batch_size 1000 --ft_epochs 20 --autoft_epochs 500 --inner_steps 10 \
