...
#SBATCH --job-name="iwildcam-autoft-50inner-500ep-all" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-autoft-50inner-500ep-all.log  # Name of the output log file
