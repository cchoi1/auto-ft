...
#SBATCH --job-name="flowers102-autoft-350is-500os-400ex-xentobj" # Renamed for clarity
#SBATCH --output=flowers102-autoft-350is-500os-400ex-xentobj.log  # Renamed output log file
