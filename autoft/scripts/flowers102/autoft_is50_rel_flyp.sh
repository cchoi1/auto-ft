...
#SBATCH --job-name="flowers102-autoft-50inner-500ep-1000ex-class-balanced-rel-flyp" # Name the job (for easier monitoring)
#SBATCH --output=flowers102-autoft-50inner-500ep-1000ex-class-balanced-rel-flyp.log  # Name of the output log file
