...
#SBATCH --job-name="flowers102-flyp" # Name the job (for easier monitoring)
#SBATCH --output=flowers102-flyp.log  # Name of the output log file
...
--num_ood_hp_examples -1 --use_class_balanced_ood --ft_epochs 100 \
--autoft_epochs 500 --inner_steps 100 --lr 1e-5 --wd 0.4 \
