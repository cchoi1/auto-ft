...
#SBATCH --job-name="flowers102-autoft-10inner-100ep-1000ex-class-balanced-seeds" # Name the job (for easier monitoring)
#SBATCH --output=flowers102-autoft-10inner-100ep-1000ex-class-balanced-seeds.log  # Name of the output log file
