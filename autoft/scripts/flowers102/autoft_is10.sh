...
#SBATCH --job-name="flowers102-autoft-3inner-100ep-100ex-class-balanced" # Name the job (for easier monitoring)
#SBATCH --output=flowers102-autoft-3inner-100ep-100ex-class-balanced.log  # Name of the output log file
...
--num_ood_hp_examples 102 --use_class_balanced_ood --ft_epochs 20 \
--autoft_epochs 100 --inner_steps 3 --lr 1e-5 --wd 0.1 \
