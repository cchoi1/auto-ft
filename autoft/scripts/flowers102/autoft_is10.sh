...
#SBATCH --job-name="flowers102-autoft-10inner-500ep-1020ex-class-balanced" # Name the job (for easier monitoring)
#SBATCH --output=flowers102-autoft-10inner-500ep-1020ex-class-balanced.log  # Name of the output log file
