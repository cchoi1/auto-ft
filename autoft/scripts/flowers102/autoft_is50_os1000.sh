...
#SBATCH --job-name="flowers102-autoft-50inner-1000ep-1000ex-class-balanced" # Name the job (for easier monitoring)
#SBATCH --output=flowers102-autoft-50inner-1000ep-1000ex-class-balanced.log  # Name of the output log file
...
--autoft_epochs 1000 --inner_steps 50 --lr 1e-5 --wd 0.1 \
