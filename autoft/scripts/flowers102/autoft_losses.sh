...
#SBATCH --job-name="flowers102-autoft-ce-dcm-flyp-350inner-1000ep-500ex-class-balanced-relflyp-regen" # Name the job (for easier monitoring)
#SBATCH --output=flowers102-autoft-ce-dcm-flyp-350inner-1000ep-500ex-class-balanced-relflyp-regen.log  # Name of the output log file
