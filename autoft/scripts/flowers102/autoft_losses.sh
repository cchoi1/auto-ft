...
#SBATCH --job-name="flowers102-autoft-ce-dcm-flyp-10inner-100ep-1000ex-class-balanced" # Name the job (for easier monitoring)
#SBATCH --output=flowers102-autoft-ce-dcm-flyp-10inner-100ep-1000ex-class-balanced.log  # Name of the output log file
