...
#SBATCH --job-name="flowers102-autoft-50inner-100ep-1000ex-not-class-balanced" # Name the job (for easier monitoring)
#SBATCH --output=flowers102-autoft-50inner-100ep-1000ex-not-class-balanced.log  # Name of the output log file
