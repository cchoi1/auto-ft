...
#SBATCH --job-name="flowers102-autoft-100inner-1000ep-500ex-class-balanced-layer-lr-xentobj" # Name the job (for easier monitoring)
#SBATCH --output=flowers102-autoft-100inner-1000ep-500ex-class-balanced-layer-lr-xentobj.log  # Name of the output log file
...
--autoft_epochs 1000 --inner_steps 100 --lr 1e-4 --wd 0.4 \
