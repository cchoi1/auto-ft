...
#SBATCH --job-name="flowers102-autoft-350inner-500ep-500ex-class-balanced-layer-lr" # Name the job (for easier monitoring)
#SBATCH --output=flowers102-autoft-350inner-500ep-500ex-class-balanced-layer-lr.log  # Name of the output log file
