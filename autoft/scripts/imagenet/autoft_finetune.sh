...
#SBATCH --cpus-per-task=8 # Increase the number of CPU cores per task to better handle data loading and preprocessing
#SBATCH --job-name="imagenet-autoft-finetune-100is-20os-1000ex" # Renamed for clarity
#SBATCH --output=imagenet-autoft-finetune-100is-20os-1000ex.log  # Renamed output log file
...
--num_ood_hp_examples 1000 --use_class_balanced_ood --inner_steps 100 --autoft_epochs 20 --ft_epochs 10 \
