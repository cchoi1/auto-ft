...
#SBATCH --job-name="imagenet-autoft-noflyp-100inner-500ep-15000ex-classbalanced-relflyp" # Name the job (for easier monitoring)
#SBATCH --output=imagenet-autoft-noflyp-100inner-500ep-15000ex-classbalanced-relflyp.log  # Name of the output log file
