...
#SBATCH --job-name="imagenet-autoft-is10" # Name the job (for easier monitoring)
#SBATCH --output=imagenet-autoft-is10.log  # Name of the output log file
...
--lr 7.5e-6 --wd 0.1 --batch-size 128 --workers 2 --warmup_length 2000 \
