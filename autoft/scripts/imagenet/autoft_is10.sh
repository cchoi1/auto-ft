...
#SBATCH --job-name="imagenet-autoft-is10-lr-100ex" # Name the job (for easier monitoring)
#SBATCH --output=imagenet-autoft-is10-lr-100ex.log  # Name of the output log file
...
--ft_epochs 10 --inner_steps 10 --autoft_epochs 1000 --val_freq 10 \
--lr 3e-5 --wd 0.1 --batch-size 128 --workers 2 --warmup_length 1000 --accumulation_steps 2 \
