...
#SBATCH --job-name="imagenet-autoft-100inner-1000ep-15000ex" # Name the job (for easier monitoring)
#SBATCH --output=imagenet-autoft-100inner-1000ep-15000ex.log  # Name of the output log file
...
--num_ood_hp_examples 15000 --use_class_balanced_ood --inner_steps 100 --autoft_epochs 1000 --ft_epochs 10 \
