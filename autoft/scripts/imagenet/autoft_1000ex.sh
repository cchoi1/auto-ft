...
#SBATCH --job-name="imagenet-autoft-100inner-100ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=imagenet-autoft-100inner-100ep-1000ex.log  # Name of the output log file
...
--losses ce dcm entropy flyp hinge l1init l1zero l2init l2zero --template openai_imagenet_template --regenerate_head \
--workers 4