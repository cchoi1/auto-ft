...
#SBATCH --job-name="iwildcam-unlabeled-autoft-50inner-500ep-1000ex-class-balanced-clipgrad" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-unlabeled-autoft-50inner-500ep-1000ex-class-balanced-clipgrad.log  # Name of the output log file
...
--num_id_unlabeled_examples 10000 --num_ood_hp_examples 1000 --use_class_balanced_ood --ft_epochs 20 --autoft_epochs 500 --inner_steps 50 \
