...
#SBATCH --job-name="iwildcam-corr-300-rand-small" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-corr-300-rand-small.log  # Name of the output log file
...
--batch-size 32 --warmup_length 500 --workers 2 --optuna_sample random \
--losses ce l2zero \
