...
#SBATCH --job-name="iwildcam-corr-layer-300-small" # Name the job (for easier monitoring)
#SBATCH --output=iwildcam-corr-layer-300-small.log  # Name of the output log file
