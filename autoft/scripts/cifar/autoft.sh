...
#SBATCH --job-name="cifar-autoft-class-balanced-1inner-100ep" # Name the job (for easier monitoring)
#SBATCH --output=cifar-autoft-class-balanced-1inner-100ep.log  # Name of the output log file
