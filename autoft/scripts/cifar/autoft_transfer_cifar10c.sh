...
#SBATCH --job-name="cifar-autoft-1inner-100ep-id=cifar10c" # Name the job (for easier monitoring)
#SBATCH --output=cifar-autoft-1inner-100ep-id=cifar10c.log  # Name of the output log file
...
--id CIFAR10C --ood CIFAR10C --eval-datasets CIFAR101,CIFAR102,CIFAR10,CIFAR10C \
