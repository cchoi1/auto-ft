...
#SBATCH --job-name="cifar-autoft-1inner-100ep-plot" # Name the job (for easier monitoring)
#SBATCH --output=cifar-autoft-1inner-100ep-plot.log  # Name of the output log file
...
--num_ood_hp_examples 100 --num_ood_unlabeled_examples 100 --ft_epochs 10 \
