...
#SBATCH --job-name="cifar-autoft-1inner-100ep-unlabeled1000" # Name the job (for easier monitoring)
#SBATCH --output=cifar-autoft-1inner-1s00ep-unlabeled1000.log  # Name of the output log file
...
--num_ood_hp_examples 100 --num_ood_unlabeled_examples 1000 --ft_epochs 10 \
