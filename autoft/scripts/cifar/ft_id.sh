...
--id CIFAR10 --ood CIFAR10C --eval-datasets CIFAR101,CIFAR102,CIFAR10,CIFAR10C \
--lr 3e-5 --wd 0.1 --batch-size 64 --warmup_length 4000 \
--load /iris/u/cchoi1/robust-optimizer/expts-CIFAR10-ft-id-ftep10_bs16_wd0.1_lr3e-05_run1-checkpoint_9.pt \
--num_ood_hp_examples 190 --ft_epochs 10 --eval_only