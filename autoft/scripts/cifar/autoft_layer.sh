...
#SBATCH --job-name="cifar-autoft-1inner-100ep-layer" # Name the job (for easier monitoring)
#SBATCH --output=cifar-autoft-1inner-100ep-layer.log  # Name of the output log file
