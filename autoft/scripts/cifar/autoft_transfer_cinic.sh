...
#SBATCH --job-name="cifar-autoft-1inner-100ep-id=cinic" # Name the job (for easier monitoring)
#SBATCH --output=cifar-autoft-1inner-100ep-id=cinic2.log  # Name of the output log file
