...
#SBATCH --job-name="cifar-ft-id-ood-unlabeled1000" # Name the job (for easier monitoring)
#SBATCH --output=cifar-ft-id-ood-unlabeled1000.log  # Name of the output log file
