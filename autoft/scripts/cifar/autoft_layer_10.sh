...
#SBATCH --job-name="cifar-autoft-10inner-100ep-layer" # Name the job (for easier monitoring)
#SBATCH --output=cifar-autoft-10inner-100ep-layer.log  # Name of the output log file
...
--autoft_epochs 100 --inner_steps 10 --lr 3.75e-6 --wd 0.1 --batch-size 64 --warmup_length 4000 --workers 2 \
