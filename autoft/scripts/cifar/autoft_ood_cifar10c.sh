...
#SBATCH --job-name="cifar-cifar10c-severity1-autoft-1inner-100ep" # Name the job (for easier monitoring)
#SBATCH --output=cifar-cifar10c-severity1-1inner-100ep.log  # Name of the output log file
...
--id CIFAR10 --ood CIFAR10C --severity 1 --eval-datasets CIFAR101,CIFAR102,CIFAR10,CIFAR10C \
