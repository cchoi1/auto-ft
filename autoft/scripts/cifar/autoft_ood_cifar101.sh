...
#SBATCH --job-name="cifar-cifar101-autoft-1inner-100ep" # Name the job (for easier monitoring)
#SBATCH --output=cifar-cifar101-1inner-100ep.log  # Name of the output log file
