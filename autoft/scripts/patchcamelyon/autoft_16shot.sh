...
#SBATCH --job-name="patchcamelyon-16shot-autoft-50inner-100ep" # Name the job (for easier monitoring)
#SBATCH --output=patchcamelyon-16shot-autoft-50inner-100ep.log  # Name of the output log file
