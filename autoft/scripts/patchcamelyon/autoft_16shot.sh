...
#SBATCH --job-name="patchcamelyon-16shot-autoft-5inner-20ep-5autoftreps" # Name the job (for easier monitoring)
#SBATCH --output=patchcamelyon-16shot-autoft-5inner-20ep-5autoftreps.log  # Name of the output log file
...
--num_ood_hp_examples 32 --ft_epochs 20 --autoft_epochs 20 --inner_steps 5 \
