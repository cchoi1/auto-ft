...
#SBATCH --job-name="patchcamelyon-16shot-autoft-10inner-50ep-5autoftreps" # Name the job (for easier monitoring)
#SBATCH --output=patchcamelyon-16shot-autoft-10inner-50ep-5autoftreps.log  # Name of the output log file
...
--id PatchCamelyonTrain --ood PatchCamelyonValHOpt --k 16 --eval-datasets PatchCamelyonValEarlyStopping,PatchCamelyonTest \
--num_ood_hp_examples 32 --ft_epochs 20 --autoft_epochs 50 --inner_steps 10 \
