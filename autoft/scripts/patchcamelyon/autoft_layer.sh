...
#SBATCH --job-name="patchcamelyon-autoft-50inner-100ep-1000ex-relflyp-regen-layer" # Name the job (for easier monitoring)
#SBATCH --output=patchcamelyon-autoft-50inner-100ep-1000ex-relflyp-regen-layer.log  # Name of the output log file
