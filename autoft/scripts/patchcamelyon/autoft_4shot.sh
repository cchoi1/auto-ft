...
#SBATCH --job-name="patchcamelyon-4shot-autoft-20inner-100ep" # Name the job (for easier monitoring)
#SBATCH --output=patchcamelyon-4shot-autoft-20inner-100ep.log  # Name of the output log file
...
--num_ood_hp_examples 8 --ft_epochs 20 --autoft_epochs 100 --inner_steps 20 \
