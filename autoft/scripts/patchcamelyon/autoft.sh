...
#SBATCH --job-name="patchcamelyon-autoft-100inner-100ep-relflyp" # Name the job (for easier monitoring)
#SBATCH --output=patchcamelyon-autoft-100inner-100ep-relflyp.log  # Name of the output log file
...
--num_ood_hp_examples 100 --use_class_balanced_ood --ft_epochs 20 --autoft_epochs 100 --inner_steps 100 \
