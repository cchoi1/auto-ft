...
#SBATCH --job-name="patchcamelyon-autoft-20inner-100ep" # Name the job (for easier monitoring)
#SBATCH --output=patchcamelyon-autoft-20inner-100ep.log  # Name of the output log file
...
--num_ood_hp_examples 100 --ft_epochs 20 --autoft_epochs 100 --inner_steps 20 \
