...
#SBATCH --job-name="patchcamelyon-autoft-100inner-100ep-1000ex-relflyp" # Name the job (for easier monitoring)
#SBATCH --output=patchcamelyon-autoft-100inner-100ep-1000ex-relflyp.log  # Name of the output log file
