...
#SBATCH --job-name="patchcamelyon-32shot-autoft-10inner-50ep-5autoftreps" # Name the job (for easier monitoring)
#SBATCH --output=patchcamelyon-32shot-autoft-10inner-50ep-5autoftreps.log  # Name of the output log file
...
--num_ood_hp_examples 64 --ft_epochs 20 --autoft_epochs 50 --inner_steps 10 \
