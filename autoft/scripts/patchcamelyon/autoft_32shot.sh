...
#SBATCH --job-name="patchcamelyon-32shot-autoft-50inner-100ep" # Name the job (for easier monitoring)
#SBATCH --output=patchcamelyon-32shot-autoft-50inner-100ep.log  # Name of the output log file
