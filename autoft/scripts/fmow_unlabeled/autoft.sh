...
#SBATCH --job-name="fmow-unlabeled-autoft-50inner-500ep-620ex-class-balanced" # Name the job (for easier monitoring)
#SBATCH --output=fmow-unlabeled-autoft-50inner-500ep-620ex-class-balanced.log  # Name of the output log file
...
--id FMOWTrain --unlabeled_id FMOWUnlabeledTrain --ood FMOWOODVal --eval-datasets FMOWIDVal,FMOWIDTest,FMOWOODTest \
...
--workers 2 --clip_gradient --load_hparams ./saved/FMOWTrain/autoft/oodFMOWOODVal_cdefhllll/no620_nouNone_afep500_is50_ftep20_bs128_wd0.1_lr1e-05_run1_seed0_ViT-B/16/hparams.json \
--no_regenerate_head
