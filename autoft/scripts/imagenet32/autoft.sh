...
#SBATCH --job-name="imagenet32-autoft-80inner-100ep-15000ex-finetune" # Name the job (for easier monitoring)
#SBATCH --output=imagenet32-autoft-80inner-100ep-15000ex-finetune.log  # Name of the output log file
...
--num_ood_hp_examples 15000 --use_class_balanced_ood --inner_steps 80 --autoft_epochs 100 --ft_epochs 10 \
