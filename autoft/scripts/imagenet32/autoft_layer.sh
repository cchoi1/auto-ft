...
#SBATCH --job-name="imagenet32-autoft-layer-50inner-500ep-1000ex" # Name the job (for easier monitoring)
#SBATCH --output=imagenet32-autoft-layer-50inner-500ep-1000ex.log  # Name of the output log file
...
--id ImageNet32 --ood ImageNetC --eval-datasets ImageNetA,ImageNetR,ImageNetSketch,ImageNetV2,ObjectNet,ImageNet \
--num_ood_hp_examples 1000 --inner_steps 50 --autoft_epochs 500 --ft_epochs 10 \
