...
#SBATCH --job-name="sst2-autoft-16shot-20inner-20ep-no-regenerate" # Name the job (for easier monitoring)
#SBATCH --output=sst2-autoft-16shot-20inner-20ep-no-regenerate.log  # Name of the output log file
...
--losses ce dcm entropy hinge flyp l1init l1zero l2init l2zero --template sst2_template --repeats 50 --no_regenerate_head
