...
#SBATCH --job-name="sst2-autoft-4shot-no-lr-wd-20inner-20ep" # Name the job (for easier monitoring)
#SBATCH --output=sst2-autoft-4shot-no-lr-wd-20inner-20ep.log  # Name of the output log file
...
--losses ce dcm entropy hinge flyp l1init l1zero l2init l2zero --template sst2_template --repeats 50 \
--no_lr_wd
...
#--load /iris/u/cchoi1/robust-optimizer/autoft/zeroshot/clip_vitb16_sst22.pt \
#--ft_data /iris/u/cchoi1/Data/csv/sst2/train.csv --csv-img-key filepath --csv-caption-key title --get_labeled_csv \
#--losses ce dcm flyp --template sst2_template --repeats 50 \
#--no_lr_wd
