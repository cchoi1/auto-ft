...
#SBATCH --job-name="sst2-autoft-4shot-20inner-20ep-no-regenerate" # Name the job (for easier monitoring)
#SBATCH --output=sst2-autoft-4shot-20inner-20ep-no-regenerate.log  # Name of the output log file
...
--losses ce hinge entropy dcm flyp l1zero l2zero l1init l2init --template sst2_template --repeats 50 --no_regenerate_head
