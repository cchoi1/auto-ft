...
#SBATCH --job-name="sst2-autoft-16shot-10inner-50ep-5autoftreps" # Name the job (for easier monitoring)
#SBATCH --output=sst2-autoft-16shot-10inner-50ep-5autoftreps.log  # Name of the output log file
