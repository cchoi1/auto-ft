...
#SBATCH --job-name="sst2-autoft-16shot-clip-grad-20inner-20ep" # Name the job (for easier monitoring)
#SBATCH --output=sst2-autoft-16shot-clip-grad-20inner-20ep.log  # Name of the output log file
