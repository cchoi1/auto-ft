...
#SBATCH --job-name="sst2-autoft-32shot-20inner-100ep" # Name the job (for easier monitoring)
#SBATCH --output=sst2-autoft-32shot-20inner-100ep.log  # Name of the output log file
