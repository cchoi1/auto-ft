...
#SBATCH --job-name="sst2-autoft-4shot-20inner-20ep-5autoftreps" # Name the job (for easier monitoring)
#SBATCH --output=sst2-autoft-4shot-20inner-20ep-5autoftreps.log  # Name of the output log file
...
--load /iris/u/cchoi1/robust-optimizer/autoft/zeroshot/clip_vitb16_sst22.pt \
--ft_data /iris/u/cchoi1/Data/csv/sst2/train.csv --csv-img-key filepath --csv-caption-key title --get_labeled_csv \
--losses ce dcm flyp --template sst2_template --repeats 50 --autoft_repeats 5
