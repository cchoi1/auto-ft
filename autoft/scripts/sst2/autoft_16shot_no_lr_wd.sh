...
#SBATCH --job-name="sst2-autoft-16shot-no-lr-wd-20inner-20ep" # Name the job (for easier monitoring)
#SBATCH --output=sst2-autoft-16shot-no-lr-wd-20inner-20ep.log  # Name of the output log file
...
--losses ce dcm flyp --template sst2_template --repeats 50 --no_lr_wd
